    ...
    <div className="min-h-screen bg-gradient-subtle flex items-center justify-center p-3 sm:p-4 lg:p-6">
      <div className="w-full max-w-sm sm:max-w-md lg:max-w-lg">
        ...
        <div className="text-center mb-4 sm:mb-6">
          ...
          <p className="text-muted-foreground mt-2 text-sm sm:text-base">Start your journaling journey</p>
        </div>

        <Card className="shadow-elevated border-0 p-4 sm:p-6">
          <CardHeader className="space-y-1 pb-3 sm:pb-4">
            <CardTitle className="text-xl sm:text-2xl lg:text-3xl text-center">Create Account</CardTitle>
          </CardHeader>
            ...
            <CardContent className="space-y-2 sm:space-y-3 px-0">
              ...
              <div className="flex items-start space-x-2 pt-2">
                <input
                  ...
                  required
                />
                <label htmlFor="agreeToTerms" className="text-xs sm:text-sm text-muted-foreground leading-relaxed">
                  I agree to the{" "}
