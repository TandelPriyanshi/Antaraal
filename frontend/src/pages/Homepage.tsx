    ...
    <div className="min-h-screen bg-background">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 xl:px-12">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 lg:gap-6 xl:gap-8">
            {features.map((feature, index) => (
              <Card 
                key={index} 
                className="group hover:shadow-elevated transition-all duration-300 border-0 bg-gradient-feature h-full"
              >
      ...
      <section className="py-12 sm:py-16 md:py-20 lg:py-24 xl:py-28">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 xl:px-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8 lg:gap-6 xl:gap-8">
            {steps.map((step, index) => (
              <div key={index} className="relative group">
                <Card className="text-center h-full hover:shadow-soft transition-all duration-300 border-0 p-4 sm:p-6">
                  <CardHeader className="pb-4">
                    <div className="w-16 h-16 sm:w-20 sm:h-20 lg:w-18 lg:h-18 xl:w-20 xl:h-20 bg-gradient-hero rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4 relative">
